...
struct Ghostty {
    ...
    static let userNotificationCategory = "app.roj.trm.userNotification"

    // The user notification "Show" action
    static let userNotificationActionShow = "app.roj.trm.userNotification.Show"
}
...
extension Notification.Name {
    ...
    static let ghosttyConfigDidChange = Notification.Name("app.roj.trm.configDidChange")
    static let GhosttyConfigChangeKey = ghosttyConfigDidChange.rawValue

    /// Color change. Object is the surface changing.
    static let ghosttyColorDidChange = Notification.Name("app.roj.trm.ghosttyColorDidChange")
    static let GhosttyColorChangeKey = ghosttyColorDidChange.rawValue

    /// Goto tab. Has tab index in the userinfo.
    static let ghosttyMoveTab = Notification.Name("app.roj.trm.moveTab")
    static let GhosttyMoveTabKey = ghosttyMoveTab.rawValue

    /// Close tab
    static let ghosttyCloseTab = Notification.Name("app.roj.trm.closeTab")

    /// Close other tabs
    static let ghosttyCloseOtherTabs = Notification.Name("app.roj.trm.closeOtherTabs")

    /// Close tabs to the right of the focused tab
    static let ghosttyCloseTabsOnTheRight = Notification.Name("app.roj.trm.closeTabsOnTheRight")

    /// Close window
    static let ghosttyCloseWindow = Notification.Name("app.roj.trm.closeWindow")

    /// Resize the window to a default size.
    static let ghosttyResetWindowSize = Notification.Name("app.roj.trm.resetWindowSize")

    /// Ring the bell
    static let ghosttyBellDidRing = Notification.Name("app.roj.trm.ghosttyBellDidRing")

    /// Readonly mode changed
    static let ghosttyDidChangeReadonly = Notification.Name("app.roj.trm.didChangeReadonly")
    static let ReadonlyKey = ghosttyDidChangeReadonly.rawValue + ".readonly"
    static let ghosttyCommandPaletteDidToggle = Notification.Name("app.roj.trm.commandPaletteDidToggle")

    /// Toggle maximize of current window
    static let ghosttyMaximizeDidToggle = Notification.Name("app.roj.trm.maximizeDidToggle")

    /// Notification sent when scrollbar updates
    static let ghosttyDidUpdateScrollbar = Notification.Name("app.roj.trm.didUpdateScrollbar")
    static let ScrollbarKey = ghosttyDidUpdateScrollbar.rawValue + ".scrollbar"

    /// Focus the search field
    static let ghosttySearchFocus = Notification.Name("app.roj.trm.searchFocus")

    /// Open a URL in an inline webview pane instead of the system browser.
    static let ghosttyOpenURLInPane = Notification.Name("app.roj.trm.openURLInPane")
    static let OpenURLInPaneURLKey = ghosttyOpenURLInPane.rawValue + ".url"

    /// Claude Code needs user attention on a specific pane.
    static let trmClaudeNeedsAttention = Notification.Name("app.roj.trm.claudeNeedsAttention")

    /// Text Tap send command: send text to a terminal pane's PTY.
    static let trmTextTapSend = Notification.Name("app.roj.trm.textTapSend")
...
extension Ghostty.Notification {
    ...
    static let NewSurfaceConfigKey = "app.roj.trm.newSurfaceConfig"

    /// Posted when a new split is requested. The sending object will be the surface that had focus. The
    /// userdata has one key "direction" with the direction to split to.
    static let ghosttyNewSplit = Notification.Name("app.roj.trm.newSplit")

    /// Close the calling surface.
    static let ghosttyCloseSurface = Notification.Name("app.roj.trm.closeSurface")

    /// Focus previous/next split. Has a SplitFocusDirection in the userinfo.
    static let ghosttyFocusSplit = Notification.Name("app.roj.trm.focusSplit")
    static let SplitDirectionKey = ghosttyFocusSplit.rawValue

    /// Goto tab. Has tab index in the userinfo.
    static let ghosttyGotoTab = Notification.Name("app.roj.trm.gotoTab")
    static let GotoTabKey = ghosttyGotoTab.rawValue

    /// New tab. Has base surface config requested in userinfo.
    static let ghosttyNewTab = Notification.Name("app.roj.trm.newTab")

    /// New window. Has base surface config requested in userinfo.
    static let ghosttyNewWindow = Notification.Name("app.roj.trm.newWindow")

    /// Present terminal. Bring the surface's window to focus without activating the app.
    static let ghosttyPresentTerminal = Notification.Name("app.roj.trm.presentTerminal")

    /// Toggle fullscreen of current window
    static let ghosttyToggleFullscreen = Notification.Name("app.roj.trm.toggleFullscreen")
    static let FullscreenModeKey = ghosttyToggleFullscreen.rawValue

    /// Notification sent to toggle split maximize/unmaximize.
    static let didToggleSplitZoom = Notification.Name("app.roj.trm.didToggleSplitZoom")

    /// Notification
    static let didReceiveInitialWindowFrame = Notification.Name("app.roj.trm.didReceiveInitialWindowFrame")
    static let FrameKey = "app.roj.trm.frame"

    /// Notification to render the inspector for a surface
    static let inspectorNeedsDisplay = Notification.Name("app.roj.trm.inspectorNeedsDisplay")

    /// Notification to show/hide the inspector
    static let didControlInspector = Notification.Name("app.roj.trm.didControlInspector")

    static let confirmClipboard = Notification.Name("app.roj.trm.confirmClipboard")
    ...
    static let didResizeSplit = Notification.Name("app.roj.trm.didResizeSplit")
    ...
    static let didEqualizeSplits = Notification.Name("app.roj.trm.didEqualizeSplits")

    /// Notification that renderer health changed
    static let didUpdateRendererHealth = Notification.Name("app.roj.trm.didUpdateRendererHealth")

    /// Notifications related to key sequences
    static let didContinueKeySequence = Notification.Name("app.roj.trm.didContinueKeySequence")
    static let didEndKeySequence = Notification.Name("app.roj.trm.didEndKeySequence")
    static let KeySequenceKey = didContinueKeySequence.rawValue + ".key"

    /// Notifications related to key tables
    static let didChangeKeyTable = Notification.Name("app.roj.trm.didChangeKeyTable")
